...
from taba.ddim.schedulers import AdvancedDDIMScheduler
...
GUIDANCE_SCALE = 1.0
BATCH_SIZE = 4
PATH_DIR = "experiments/sdxl_edit/ddim"
N_PROMPTS = 512
...
FORWARD_BEFORE_T = 2
FORWARD_SEED = 113
LATENTS_PATH = f"experiments/sdxl/ddim"
if WITH_FORWARD:
    LATENTS_PATH += f"_forward{FORWARD_BEFORE_T}_s{FORWARD_SEED}"
...
@hydra.main(version_base=None, config_path=CONFIG_DIR, config_name="sdxl/edit")
